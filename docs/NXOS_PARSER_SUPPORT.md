...
The NX-OS parser (`netgraph.parsers.nxos_parser.NXOSParser`) parses Cisco NX-OS device configurations. It inherits from `IOSParser` and overrides methods where NX-OS syntax diverges from IOS.

**Class:** `netgraph.parsers.nxos_parser.NXOSParser`
