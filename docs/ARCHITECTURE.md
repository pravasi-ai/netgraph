# netgraph — Architecture

## Overview

`netgraph` is a Python library that parses vendor network device CLI configurations (plain text) into typed, validated Pydantic data models.
