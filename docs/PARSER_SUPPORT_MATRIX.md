...
This document provides a comprehensive overview of parser support across all network operating systems (OS types) in the configz project. It serves as a central reference for understanding which protocols, features, and OS versions are currently supported.
...
**Parser Class:** `configz.parsers.ios_parser.IOSParser`
...
**Parser Class:** `configz.parsers.eos_parser.EOSParser`
...
2. **Data Model:** Create/update Pydantic model in `configz/models/`
...
2. **Parser Class:** Create new parser in `configz/parsers/`
...
### Project Information
- **Project:** configz - Vendor-agnostic config analysis engine
