...
from netgraph.parsers.base import BaseParser
...
from netgraph.models.static_route import StaticRoute
from netgraph.models.acl import ACLConfig, ACLEntry
from netgraph.models.community_list import (
    CommunityListConfig,
    CommunityListEntry,
    ASPathListConfig,
    ASPathListEntry,
)
from netgraph.models.isis import ISISConfig, ISISRedistribute
from netgraph.models.eigrp import EIGRPConfig, EIGRPNetwork, EIGRPRedistribute, EIGRPMetric
from netgraph.models.rip import RIPConfig, RIPRedistribute, RIPTimers
from netgraph.models.ntp import NTPConfig, NTPServer, NTPAuthKey
from netgraph.models.snmp import SNMPConfig, SNMPCommunity, SNMPHost, SNMPView, SNMPGroup, SNMPUser
from netgraph.models.logging_config import SyslogConfig, LoggingHost
from netgraph.models.banner import BannerConfig
from netgraph.models.line import LineConfig, LineType
from netgraph.models.qos import (
    ClassMapConfig, ClassMapMatch,
    PolicyMapConfig, PolicyMapClass, PolicyMapPolice, PoliceAction, PolicyMapShape, PolicyMapSet,
)
from netgraph.models.nat import NATConfig, NATPool, NATStaticEntry, NATDynamicEntry, NATTimeouts
from netgraph.models.crypto import (
    CryptoConfig, IKEv1Policy, IKEv1Key, IKEv2Proposal, IKEv2Policy,
    IPSecTransformSet, CryptoMapEntry, CryptoMap, IPSecProfile,
)
from netgraph.models.bfd import BFDConfig, BFDTemplate, BFDInterval, BFDMap
from netgraph.models.ipsla import IPSLAOperation, IPSLASchedule, IPSLAReaction
from netgraph.models.eem import EEMApplet, EEMEvent, EEMAction
from netgraph.models.object_tracking import ObjectTrack, TrackListObject
from netgraph.models.multicast import MulticastConfig, PIMRPAddress, MSDPPeer
            ...
            for nc in eigrp_obj.re_search_children(r"^\s+network\s+"):
                ...
                if nm:
                    try:
                        ...
                        from netgraph.models.eigrp import EIGRPNetwork
        ...
        for rip_obj in parse.find_objects(r"^router\s+rip$"):
            ...
            for rc in rip_obj.re_search_children(r"^\s+redistribute\s+"):
                ...
                if rm:
                    ...
                    from netgraph.models.rip import RIPRedistribute
            ...
            if tc:
                ...
                if tm:
                    from netgraph.models.rip import RIPTimers
                    timers = RIPTimers(
